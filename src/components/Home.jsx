...
const Home = () => {
    ...
    >
      ...
      >
        <h1 className="text-2xl md:text-6xl font-bold mb-2 md:mb-4 text-slate-100 hover:text-slate-400 transition-colors duration-300">
          WELCOME
        </h1>
        <p className="md:text-3xl text-xl text-slate-400 hover:text-slate-200 transition-colors duration-300">
