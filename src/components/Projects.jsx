...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="py-20 px-4 md:px-12 bg-gradient-to-b from-gray-700 via-green-900 to-gray-900 "
      ref={ref}
    >
      <div className="max-w-6xl mx-auto">
        <motion.h2
          className="text-4xl md:text-5xl font-bold text-center mb-16 text-white overflow-hidden"
